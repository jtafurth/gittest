...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p class="texto" style="text-align:justify">
        ...
        realizando ante la Cámara de Comercio de Basdasículos 4 y 5 del Decreto 2354 de 2012) se obliga el usuario a tratarla como un dato confidencial, personal e intransferible, 
        siendo su responsabilidad exclusiva el manejo, administración y custodia de la clave generada.
    </p>
    dasd
    <p align="center">dasdasdas
        <asp:Label ID="ldasdasdasdasdblError" runat="sesadasasdrver" ForeColor="#FF3300" CssClass="error"></asp:Label>
    </p>dasdasd
